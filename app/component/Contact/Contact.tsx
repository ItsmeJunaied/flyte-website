              ...
              <div className="w-full   flex-col justify-start items-start gap-2 inline-flex">
                ...
                <Select>
                  ...
                  <SelectContent className="max-w-full overflow-x-hidden">
                    ...
                    <SelectItem value="cloudServices">
                      Cloud Services
                    </SelectItem>
                  </SelectContent>
                </Select>
              ...
              <div className="w-full   flex-col justify-start items-start gap-2 inline-flex">
                ...
                <Select>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="customSolutions">
                      Custom Solutions
                    </SelectItem>
                  </SelectContent>
                </Select>
            ...
            <div className="self-stretch h-[329px] flex-col justify-start items-start gap-6 flex">
              <div className="self-stretch h-[265px] flex-col justify-start items-start gap-4 flex">
                <div className="self-stretch h-[159px] flex-col justify-start items-start gap-2 flex">
                  ...
                  <textarea
                    className="self-stretch grow shrink basis-0 p-4 bg-white rounded-lg border border-[#cccccc] text-[#666666] text-sm font-normal font-['Noto Sans'] leading-normal outline-none hover:border-btnColor focus:border-btnColor"
              ...
              <div className="self-stretch h-10 flex-col justify-start items-center gap-2 flex">
                <button className="w-[180px] h-10 px-8 py-3 bg-[#5856d6] rounded-md text-white text-sm font-semibold ">
                  Send Message
                </button>
              </div>
            </div>
