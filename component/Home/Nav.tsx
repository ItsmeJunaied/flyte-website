                  ...
                  {item.type === "dropdown" ? (
                    <>
                      <div className={`nav__link dropdown__button ${isActive ? "active" : ""}`}>
                        <p className={`text-black hover:text-[#2B6CB0] ${isActive ? "text-blue-500 border-b-2 border-btnColor" : ""}`}>{item.name}</p>
                    ...
                    <Link className={`h-full flex items-center ${isActive ? "text-blue-500 border-b-2 border-green-300" : ""}`} href={item.path}>
