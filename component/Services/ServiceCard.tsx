  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div className="w-40 md:w-60 h-[120px] md:h-[155px] bg-emerald-300 md:ml-32 -mb-12" ><img src="https://i.ibb.co.com/BzrstK4/Image1.png" alt="" /></div>
          <div className="w-40 md:w-60 h-[120px] md:h-[155px] bg-emerald-500 mr-32" ><img src="https://i.ibb.co.com/QdrF5BQ/Image2.png" alt="" /></div>
          <div className="w-40 md:w-60 h-[120px] md:h-[155px] bg-emerald-700 md:ml-32 -mt-12" ><img src="https://i.ibb.co.com/7W1VRHX/Image3.png" alt="" /></div>
        </div>

        <div className="md:w-[460px] h-[365px] space-y-6">
          <p className="text-[#757575] text-sm uppercase tracking-wide">
            Team Extension
          </p>
          ...
          <p className="text-[#6e6e6e] text-xs font-normal">
            Team Extension helps you scale quickly by augmenting your in-house
            team with specialized talent, offering flexibility to meet project
            demands without the overhead of full-time hires.
          </p>
          <div>
